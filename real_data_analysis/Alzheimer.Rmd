...
ggplot(data=ht_CB2,aes(UMI_count,fill=group))+geom_histogram(position="dodge",bins = 40)+
    scale_x_log10(limits=c(100,Alz_knee+1000))+ylim(c(0,3300))+
    scale_fill_discrete(labels = c("CB2", "Background"))+ 
    theme(legend.position="top",legend.title = element_blank())

ggplot(data=ht_CB2extra,aes(UMI_count,fill=group))+geom_histogram(position="dodge",bins = 40)+
    scale_x_log10(limits=c(100,Alz_knee+1000))+ylim(c(0,3300))+
    scale_fill_discrete(labels = c("Additional CB2", "Background"))+ 
    theme(legend.position="top",legend.title = element_blank())

ggplot(data=ht_ED,aes(UMI_count,fill=group))+geom_histogram(position="dodge",bins = 40)+
    scale_x_log10(limits=c(100,Alz_knee+1000))+ylim(c(0,3300))+
...
ggplot(data=ht_CB2_Subpop5,aes(UMI_count,fill=group))+
    ...
    scale_x_log10(limits=c(100 ,15579+1000))+ylim(c(0,3300))+
    scale_fill_discrete(labels = c("CB2 Subpop5", "Background"))+ 
    coord_trans(y="log1p")+theme_bw() + theme(axis.text=element_text(size=10),axis.title.y = element_blank(),axis.title.x = element_blank(),legend.title = element_blank(),legend.position = "top",panel.border = element_rect(colour = "black", fill=NA, size=1.5), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))+scale_y_continuous(breaks = c(10,30,100,300,1000,3000))
...
# Revision: Add small and large background with CB2 unique cells.
