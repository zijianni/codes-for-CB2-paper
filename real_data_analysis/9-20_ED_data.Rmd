...
# set.seed(SEED)
# eOut <- emptyDrops(placenta_r,upper = placenta_knee, lower=100)
...
tiff(filename ="~/Google Drive/Hallu/codes/ckgroup/DropletUtils/manuscript/Rplots/placenta_C14_D%03d.tif",width=20,height=10,units="cm",res=300,pointsize=10, compression = "lzw")
Htmap(placenta_r[sort(filter_mr(n1)[1:100]),colnames(placenta_sub1)],"placenta", Plot = "D")
dev.off()

tiff(filename ="~/Google Drive/Hallu/codes/ckgroup/DropletUtils/manuscript/Rplots/placenta_C14_H.tif",width=20,height=20,units="cm",res=300,pointsize=10, compression = "lzw")
Htmap(placenta_r[sort(filter_mr(n1)[1:100]),colnames(placenta_sub1)],"placenta", Plot = "H")
dev.off()

tiff(filename ="~/Google Drive/Hallu/codes/ckgroup/DropletUtils/manuscript/Rplots/placenta_C6_D%03d.tif",width=20,height=10,units="cm",res=300,pointsize=10, compression = "lzw")
Htmap(placenta_r[sort(filter_mr(n2)[1:100]),colnames(placenta_sub2)],"placenta", Plot = "D")
dev.off()

tiff(filename ="~/Google Drive/Hallu/codes/ckgroup/DropletUtils/manuscript/Rplots/placenta_C6_H.tif",width=20,height=20,units="cm",res=300,pointsize=10, compression = "lzw")
Htmap(placenta_r[sort(filter_mr(n2)[1:100]),colnames(placenta_sub2)],"placenta", Plot = "H")
dev.off()

tiff(filename ="~/Google Drive/Hallu/codes/ckgroup/DropletUtils/manuscript/Rplots/placenta_C11_D%03d.tif",width=20,height=10,units="cm",res=300,pointsize=10, compression = "lzw")
Htmap(placenta_r[sort(filter_mr(n1)[1:100]),colnames(placenta_sub3)],"placenta", Plot = "D")
dev.off()

tiff(filename ="~/Google Drive/Hallu/codes/ckgroup/DropletUtils/manuscript/Rplots/placenta_C11_H.tif",width=20,height=20,units="cm",res=300,pointsize=10, compression = "lzw")
Htmap(placenta_r[sort(filter_mr(n1)[1:100]),colnames(placenta_sub3)],"placenta", Plot = "H")
dev.off()

tiff(filename ="~/Google Drive/Hallu/codes/ckgroup/DropletUtils/manuscript/Rplots/placenta_C12_D%03d.tif",width=20,height=10,units="cm",res=300,pointsize=10, compression = "lzw")
Htmap(placenta_r[sort(filter_mr(n1)[1:100]),colnames(placenta_sub4)],"placenta", Plot = "D")
dev.off()

tiff(filename ="~/Google Drive/Hallu/codes/ckgroup/DropletUtils/manuscript/Rplots/placenta_C12_H.tif",width=20,height=20,units="cm",res=300,pointsize=10, compression = "lzw")
Htmap(placenta_r[sort(filter_mr(n1)[1:100]),colnames(placenta_sub4)],"placenta", Plot = "H")
dev.off()
