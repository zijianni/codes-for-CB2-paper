...
gp_Mn <- mk_hist(c("CD14","CD68"),Mn_cell,PBMC8K_r,diff_PBMC8K, upper = PBMC8K_knee)+
    labs(title="CD14+ Monocytes - Subpop1")
...
plot(gp_NK + gp_Mn + gp_T + gp_B + gp_Mk + plot_layout(design = layout))
...
MK_gene2 <-c("NKG7","CD14","CD3D","CD19","PF4")
for(GG in MK_gene2){
    print(GG)
