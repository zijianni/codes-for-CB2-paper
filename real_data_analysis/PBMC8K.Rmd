...
```{r}
Extra_PBMC8K <- colnames(PBMC8K_r)[colSums(PBMC8K_r)>=0.1*PBMC8K_knee]
Extra_PBMC8K <- setdiff(Extra_PBMC8K,colnames(PBMC8K_CB2)) 

Htmap_revision(Extra_PBMC8K,PBMC8K_r, background_threshold=100, AddBackground=F)
